...
% ind_contact=1000
ind_contact=round(ind_contact);
cfL=createFit_line_poly_N(z_piezo_NM(1:ind_contact),z_tip_NM(1:ind_contact),1,1)
...
z_tip_NM_base=z_tip_NM_base(ind_contact:end);
z_piezo_NM=z_piezo_NM(ind_contact:end);
